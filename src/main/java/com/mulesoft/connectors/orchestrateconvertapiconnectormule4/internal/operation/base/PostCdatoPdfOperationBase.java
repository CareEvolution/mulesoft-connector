...
public abstract class PostCdatoPdfOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/CDAtoPDF";
  ...
  public PostCdatoPdfOperationBase() {
    super();
  }

  public PostCdatoPdfOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postCdatoPdf(
  ...
  protected void postCdatoPdfMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(postCdatoPdfBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
