...
public abstract class PostFhirr4toOmopOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/FHIRR4ToOMOP";
  ...
  public PostFhirr4toOmopOperationBase() {
    super();
  }

  public PostFhirr4toOmopOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postFhirr4toOmop(
      RestConfiguration config,
      RestConnection connection,
      boolean includePiiTablesQueryParam,
  ...
  protected void postFhirr4toOmopMain(
      RestConfiguration config,
      RestConnection connection,
      boolean includePiiTablesQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addQueryParam("includePiiTables", includePiiTablesQueryParam)
            .setBody(postFhirr4toOmopBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
