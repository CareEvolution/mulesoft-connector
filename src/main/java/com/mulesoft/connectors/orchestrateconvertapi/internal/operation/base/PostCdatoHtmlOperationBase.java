...
public abstract class PostCdatoHtmlOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/CDAtoHTML";
  ...
  public PostCdatoHtmlOperationBase() {
    super();
  }

  public PostCdatoHtmlOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postCdatoHtml(
  ...
  protected void postCdatoHtmlMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(postCdatoHtmlBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
