...
public abstract class PostCdatoFhirr4OperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/CDAtoFHIRR4";
  ...
  public PostCdatoFhirr4OperationBase() {
    super();
  }

  public PostCdatoFhirr4OperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postCdatoFhirr4(
  ...
  protected void postCdatoFhirr4Main(
      RestConfiguration config,
      RestConnection connection,
      boolean includeCdaInTheOutputQueryParam,
      boolean notIncludeDocumentIdInDataSourceQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addQueryParam("includeCdaInTheOutput", includeCdaInTheOutputQueryParam)
            .addQueryParam(
                "notIncludeDocumentIdInDataSource", notIncludeDocumentIdInDataSourceQueryParam)
            .setBody(postCdatoFhirr4Body, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
