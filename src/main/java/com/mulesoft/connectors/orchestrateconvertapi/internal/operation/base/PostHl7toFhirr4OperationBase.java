...
public abstract class PostHl7toFhirr4OperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/HL7toFHIRR4";
  ...
  public PostHl7toFhirr4OperationBase() {
    super();
  }

  public PostHl7toFhirr4OperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postHl7toFhirr4(
  ...
  protected void postHl7toFhirr4Main(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(postHl7toFhirr4Body, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
