...
public abstract class PostX12toFhirr4OperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/X12toFHIRR4";
  ...
  public PostX12toFhirr4OperationBase() {
    super();
  }

  public PostX12toFhirr4OperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void postX12toFhirr4(
  ...
  protected void postX12toFhirr4Main(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(postX12toFhirr4Body, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
