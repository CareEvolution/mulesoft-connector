...
public class PostCombineFhirr4bundlesOutputMetadataResolver extends FromJsonOutputMetadataResolver {
  @Override
  ...
  public String getResolverName() {
    return "post-combine-fhirr4bundles-output-type-resolver";
  }
